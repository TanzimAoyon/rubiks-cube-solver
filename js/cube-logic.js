// js/cube-logic.js - THE VIRTUAL CUBE BRAIN

// 1. GENERIC ROTATOR
function rotateFaceClockwise(face) {
    let old = [...face];
    face[2] = old[0]; face[8] = old[2]; face[6] = old[8]; face[0] = old[6];
    face[5] = old[1]; face[7] = old[5]; face[3] = old[7]; face[1] = old[3];
    return face;
}

// 2. MAIN VIRTUAL MOVE FUNCTION
